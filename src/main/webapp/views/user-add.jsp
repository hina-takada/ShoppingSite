...
<main class="add-main">
	...
	<form class="add-form" action="AddValidation.action" method="post"
		autocomplete="off">

		<div class="field">
			<!-- 半角英数文字 -->
			<label class="form-label">会員ID<span>*</span></label> <input
				type="text" name="id" placeholder="ID入力" value="${insertUser.id}"
		...
		<div class="field">
			...
			<div class="pass_box">
				<input id="pass" type="password" name="pass" placeholder="パスワード入力"
					value="${insertUser.pass}" autocomplete="new-password"> <i
		...
		<div class="field">
			...
			<div class="pass_box">
				<input  id="passConfirm" type="password" name="passConfirm" placeholder="もう一度パスワード入力"
					value="${insertUser.passConfirm}"autocomplete="new-password"> <i id="confirm-eye"
		...
		<div class="field">
			<label class="form-label">名前(姓)<span>*</span></label> <input
				type="text" name="lastName" placeholder="例:山田"
				value="${insertUser.lastName}"> <span
				class="error error-length is-hidden"></span>
		</div>

		<div class="field">
			<label class="form-label">名前(名)<span>*</span></label> <input
				type="text" name="firstName" placeholder="例:太郎"
		...
		<div class="field">
			<label class="form-label">住所<span>*</span></label> <input type="text"
				name="address" placeholder="○○県○○市○○XXXX-XX"
		...
		<div class="field">
			<label class="form-label">メールアドレス<span>*</span></label> <input
				type="email" name="mailAddress" placeholder="○○○○@mail.com"
				value="${insertUser.mailAddress}"> <span
				class="error error-length is-hidden"></span>
		</div>
